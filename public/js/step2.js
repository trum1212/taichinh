...
import { uiConfig } from './configs.js'; // Sửa tên tệp theo yêu cầu
...
function applyUiConfig() {
    if (appLogo && uiConfig.logoUrl) {
        appLogo.src = uiConfig.logoUrl;
    }
    if (uiConfig.themeColors) {
        for (const [key, value] of Object.entries(uiConfig.themeColors)) {
